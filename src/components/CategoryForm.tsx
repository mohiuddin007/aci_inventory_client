    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <Label htmlFor="category" className="mb-3">Category Name</Label>
            <Input  placeholder="Write category name" id="category" {...register("name", { required: "Category name is required" })} />
